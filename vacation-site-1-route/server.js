...
app.get('/city', function(req, res) {
  // http://localhost:3000/city?title=venice&src_1=https://fthmb.tqn.com/yaSJS3o6DipIAeihV5AMX9S8x-M=/960x0/filters:no_upscale()/italy--venice--elevated-view-of-canal-in-city-543346423-5982583b396e5a0011c9ef3e.jpg&src_2=https://fthmb.tqn.com/yaSJS3o6DipIAeihV5AMX9S8x-M=/960x0/filters:no_upscale()/italy--venice--elevated-view-of-canal-in-city-543346423-5982583b396e5a0011c9ef3e.jpg&src_3=https://fthmb.tqn.com/yaSJS3o6DipIAeihV5AMX9S8x-M=/960x0/filters:no_upscale()/italy--venice--elevated-view-of-canal-in-city-543346423-5982583b396e5a0011c9ef3e.jpg

  if (req.query.title) {
    res.render('template.hbs', {
      title: req.query.title,
      src_1: req.query.src_1,
      src_2: req.query.src_2,
      src_3: req.query.src_3
    })
  }
  else {
    res.render('404.hbs')
